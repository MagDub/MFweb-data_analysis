...
for ID_n = 1:n_
    ...
    ID = usermat_completed(ID_n);
        ...
        short_ind = find(mat_AB(:,1)==block_ & mat_AB(:,3)==6);
        long_ind = find(mat_AB(:,1)==block_ & mat_AB(:,3)==11);
        ...
        short_ind = find(mat_BD(:,1)==block_ & mat_BD(:,3)==6);
        long_ind = find(mat_BD(:,1)==block_ & mat_BD(:,3)==11);
        ...
        short_ind = find(mat_ABD(:,1)==block_ & mat_ABD(:,3)==6);
        long_ind = find(mat_ABD(:,1)==block_ & mat_ABD(:,3)==11);
        ...
        short_ind = find(mat_AD(:,1)==block_ & mat_AD(:,3)==6);
        long_ind = find(mat_AD(:,1)==block_ & mat_AD(:,3)==11);
...
save(strcat(dir_save, 'frequencies_B3.mat'), 'frequencies');
