...
web_ind_SH = find(contains(web_desc.model_parameters_desc,'eta_short'));
web_ind_LH = find(contains(web_desc.model_parameters_desc,'eta_long'));
...
NADA_param_SH = data_NADA.model_parameters_Q0uni(:,6);
NADA_param_LH = data_NADA.model_parameters_Q0uni(:,7);

web_param_SH = data_web.model_parameters(:,web_ind_SH);
web_param_LH = data_web.model_parameters(:,web_ind_LH);

dev_param_SH = data_dev.model_parameters(:,7);
dev_param_LH = data_dev.model_parameters(:,8);
...
%% Export
export_fig(['Fig/Fig_eta.tif'],'-nocrop','-r200')
