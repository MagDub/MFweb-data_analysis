function fit_mod5_t1(ID, data_fol)
    ...
    settings.params.param_names     = {'Q0' 'gamma'  '' };   
    settings.params.lb              = [param_bounds_Q0(1) param_bounds_gamma(1) param_bounds_gamma(1)];    % lower bound
    settings.params.ub              = [param_bounds_Q0(2) param_bounds_gamma(2) param_bounds_gamma(2)];    % upper bound
