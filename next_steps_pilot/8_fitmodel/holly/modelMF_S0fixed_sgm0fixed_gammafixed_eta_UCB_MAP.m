function [nMAP, nLogL, mo, logL] = modelMF_S0fixed_sgm0fixed_gammafixed_eta_UCB_MAP(param_val,param_names,sID,settings,data,gameIDs, prior, param_names_prior)
holly = 0;
...
%% initialise model
mo = initialise_model_MF_S0fixed_sgm0fixed_gammafixed_eta(settings);
