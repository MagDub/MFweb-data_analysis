function fit_mod8_t1(ID, data_fol)
    ...
    settings.params.param_names     = {'Q0' 'gamma'  ''  'xi'  ''  'eta' ''};   
    settings.params.lb              = [param_bounds_Q0(1) param_bounds_gamma(1) param_bounds_gamma(1) param_bounds_xi(1) param_bounds_xi(1) param_bounds_eta(1) param_bounds_eta(1)];    % lower bound
    settings.params.ub              = [param_bounds_Q0(2) param_bounds_gamma(2) param_bounds_gamma(2) param_bounds_xi(2) param_bounds_xi(2) param_bounds_eta(2) param_bounds_eta(2)];    % upper bound
    ...
    param_names = {'Q0', 'gamma', 'gamma', 'xi', 'xi', 'eta', 'eta'};
