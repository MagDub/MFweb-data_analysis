function [nMAP, nLogL, mo, logL] = modelMF_S0fixed_eta_thomp4param_MAP_2sgm0_etaT(param_val,param_names,sID,settings,data,gameIDs, prior, param_names_prior, trials)
holly = 0;
