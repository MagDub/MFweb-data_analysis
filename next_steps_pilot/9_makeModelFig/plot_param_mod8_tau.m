...
tau_SH = param_SH;
tau_LH = param_LH;
save('../../data/data_for_figs/mod8_eta8_tau_SH.mat', 'tau_SH')
save('../../data/data_for_figs/mod8_eta8_tau_LH.mat', 'tau_LH')
...
% Export
addpath('../../export_fig')
export_fig(['./fig/Fig_param_tau_mod8_eta8.tif'],'-nocrop','-r200')