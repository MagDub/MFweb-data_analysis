...
fct_cor_mat_factors_LH <- function() {
  
  load(file = "./all_data.Rdata")
  
  # Choose which ones to keep
  data_ <- data_all[, c('scores_f3', 'scores_f2', 'scores_f1', 'average_first_apple_LH')]
  ...
  p_mat_biv = p_mat_all[c("average_first_apple_LH"),c("scores_f3", "scores_f2", "scores_f1")]
  r_mat_biv = r_mat_all[c("average_first_apple_LH"),c("scores_f3", "scores_f2", "scores_f1")]
  ...
  data_part_ <- data_all[, c('scores_f3', 'scores_f2', 'scores_f1', 'average_first_apple_LH', 'age', 'IQscore')]
  ...
  r_mat_partial['scores_f3']=pcor.test(y_data$average_first_apple_LH, y_data$scores_f3, y_data[,c("age","IQscore")])$estimate
  r_mat_partial['scores_f2']=pcor.test(y_data$average_first_apple_LH, y_data$scores_f2, y_data[,c("age","IQscore")])$estimate
  r_mat_partial['scores_f1']=pcor.test(y_data$average_first_apple_LH, y_data$scores_f1, y_data[,c("age","IQscore")])$estimate

  # same col names as p_mat_biv
  p_mat_partial = p_mat_biv
  p_mat_partial['scores_f3']=pcor.test(y_data$average_first_apple_LH, y_data$scores_f3, y_data[,c("age","IQscore")])$p.value
  p_mat_partial['scores_f2']=pcor.test(y_data$average_first_apple_LH, y_data$scores_f2, y_data[,c("age","IQscore")])$p.value
  p_mat_partial['scores_f1']=pcor.test(y_data$average_first_apple_LH, y_data$scores_f1, y_data[,c("age","IQscore")])$p.value
