...
cor_mat_ASRS_param_partial <- function() {
  ...
  M_vec_partial = M_vec
  M_vec_partial["xi_mean"]=pcor.test(y_data$ASRS_Sum, y_data$xi_mean, y_data[,c("age","IQscore")])$estimate
  M_vec_partial["eta_mean"]=pcor.test(y_data$ASRS_Sum, y_data$eta_mean, y_data[,c("age","IQscore")])$estimate
  M_vec_partial["sgm0_mean"]=pcor.test(y_data$ASRS_Sum, y_data$sgm0_mean, y_data[,c("age","IQscore")])$estimate
  M_vec_partial["Q0"]=pcor.test(y_data$ASRS_Sum, y_data$Q0, y_data[,c("age","IQscore")])$estimate
  
  # same col names as p_vec
  p_vec_partial = p_vec
  p_vec_partial["xi_mean"]=pcor.test(y_data$ASRS_Sum, y_data$xi_mean, y_data[,c("age","IQscore")])$p.value
  p_vec_partial["eta_mean"]=pcor.test(y_data$ASRS_Sum, y_data$eta_mean, y_data[,c("age","IQscore")])$p.value
  p_vec_partial["sgm0_mean"]=pcor.test(y_data$ASRS_Sum, y_data$sgm0_mean, y_data[,c("age","IQscore")])$p.value
  p_vec_partial["Q0"]=pcor.test(y_data$ASRS_Sum, y_data$Q0, y_data[,c("age","IQscore")])$p.value
