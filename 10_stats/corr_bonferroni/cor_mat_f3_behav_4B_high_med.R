...
cor_mat_f3_behav_4B_high_med <- function() {
  ...
  data_all <- data_tmp_all[, c('pickedD_mean', 'pickedC_mean', 'pickedhigh_mean', 'pickedmedium_mean', 'scores_f3')]
  ...
  output=paste(
    ...
    "; F3 and medium-value: R=", 
    round(df_r$pickedmedium_mean,3),", p_c=", round(df_p_c$pickedmedium_mean,3),", p_u=", round(df_p_u$pickedmedium_mean,3),
    sep='') 
