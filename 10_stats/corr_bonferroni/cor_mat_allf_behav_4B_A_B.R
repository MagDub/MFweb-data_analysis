...
cor_mat_allf_behav_4B_A_B <- function() {
  ...
  data_all <- data_tmp_all[, c('pickedD_mean', 'pickedC_mean', 'pickedA_mean', 'pickedB_mean', 'scores_f1', 'scores_f2', 'scores_f3')]
  ...
  p_mat_small = p_mat_all[c("scores_f1", "scores_f2", "scores_f3"),c("pickedD_mean", "pickedC_mean", "pickedA_mean", "pickedB_mean")]
  r_mat_small = r_mat_all[c("scores_f1", "scores_f2", "scores_f3"),c("pickedD_mean", "pickedC_mean", "pickedA_mean", "pickedB_mean")]
  ...
  output=paste(
    ...
    "; F1 and certain-standard bandit: R=", 
    round(df_r['scores_f1',]$pickedA_mean,3),", p_c=", round(df_p_c['scores_f1',]$pickedA_mean,3),", p_u=", round(df_p_u['scores_f1',]$pickedA_mean,3),  
    "; F1 and standard bandit: R=", 
    round(df_r['scores_f1',]$pickedB_mean,3),", p_c=", round(df_p_c['scores_f1',]$pickedB_mean,3),", p_u=", round(df_p_u['scores_f1',]$pickedB_mean,3),  
    ...
    "; F2 and certain-standard bandit: R=", 
    round(df_r['scores_f2',]$pickedA_mean,3),", p_c=", round(df_p_c['scores_f2',]$pickedA_mean,3),", p_u=", round(df_p_u['scores_f2',]$pickedA_mean,3),  
    "; F2 and standard bandit: R=", 
    round(df_r['scores_f2',]$pickedB_mean,3),", p_c=", round(df_p_c['scores_f2',]$pickedB_mean,3),", p_u=", round(df_p_u['scores_f2',]$pickedB_mean,3),  
    ...
    round(df_r['scores_f3',]$pickedA_mean,3),", p_c=", round(df_p_c['scores_f3',]$pickedA_mean,3),", p_u=", round(df_p_u['scores_f3',]$pickedA_mean,3),   
    "; F3 and standard bandit: R=", 
    round(df_r['scores_f3',]$pickedB_mean,3),", p_c=", round(df_p_c['scores_f3',]$pickedB_mean,3),", p_u=", round(df_p_u['scores_f3',]$pickedB_mean,3),  
    sep='') 
