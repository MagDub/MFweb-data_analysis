...
cor_mat_BIS_behav_3B_partial <- function() {
  ...
  M_vec_partial = M_vec
  M_vec_partial["pickedD_mean"]=pcor.test(y_data$BIS11_TotalScore, y_data$pickedD_mean, y_data[,c("age","IQscore")])$estimate
  M_vec_partial["pickedC_mean"]=pcor.test(y_data$BIS11_TotalScore, y_data$pickedC_mean, y_data[,c("age","IQscore")])$estimate
  M_vec_partial["pickedhigh_mean"]=pcor.test(y_data$BIS11_TotalScore, y_data$pickedhigh_mean, y_data[,c("age","IQscore")])$estimate
  
  # same col names as p_vec
  p_vec_partial = p_vec
  p_vec_partial["pickedD_mean"]=pcor.test(y_data$BIS11_TotalScore, y_data$pickedD_mean, y_data[,c("age","IQscore")])$p.value
  p_vec_partial["pickedC_mean"]=pcor.test(y_data$BIS11_TotalScore, y_data$pickedC_mean, y_data[,c("age","IQscore")])$p.value
  p_vec_partial["pickedhigh_mean"]=pcor.test(y_data$BIS11_TotalScore, y_data$pickedhigh_mean, y_data[,c("age","IQscore")])$p.value
