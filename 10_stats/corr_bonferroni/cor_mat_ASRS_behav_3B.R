...
cor_mat_ASRS_behav_3B <- function() {
  ...
  data_quest <- dataMFweb[, c('ASRS_Sum')]
  ...
  p_mat_u = p_mat_all[c("ASRS_Sum"),c("pickedD_mean", "pickedC_mean", "pickedhigh_mean")]
  r_mat_small = r_mat_all[c("ASRS_Sum"),c("pickedD_mean", "pickedC_mean", "pickedhigh_mean")]
