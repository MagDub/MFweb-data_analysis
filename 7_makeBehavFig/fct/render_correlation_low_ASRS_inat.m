...
function [] = render_correlation_low_ASRS_inat(to_del)
...
%     set(l,'LineWidth', 1.5, 'Color',cols(4,:)); hold on
    ...
    xlabel('ASRS inattention','FontName','Arial','Fontweight','bold','FontSize',12);

    xlimmin=min(ASRS_inat);
    xlimmax=max(ASRS_inat);
