...
web_ind_SH = find(contains(web_desc.model_parameters_desc,'sgm0_short'));
web_ind_LH = find(contains(web_desc.model_parameters_desc,'sgm0_long'));
...
NADA_param_SH = data_NADA.model_parameters_Q0uni(:,1);
NADA_param_LH = data_NADA.model_parameters_Q0uni(:,2);

web_param_SH = data_web.model_parameters(:,web_ind_SH);
web_param_LH = data_web.model_parameters(:,web_ind_LH);

dev_param_SH = data_dev.model_parameters(:,2);
dev_param_LH = data_dev.model_parameters(:,3);
...
max_v = max([max([NADA_param_SH,NADA_param_LH]),max([web_param_SH,web_param_LH]), max([dev_param_SH,dev_param_LH])]);
...
%% Export
export_fig(['Fig/Fig_sgm0.tif'],'-nocrop','-r200')
