function inp_params = prep_inp_params_Norm(param_bounds, saving_dir, n_sim, param_mean, param_std)
    ...
    inp_params = [v_sgm0_1, v_sgm0_2, v_Q0, v_xi_1, v_xi_2, v_eta_1, v_eta_2];
