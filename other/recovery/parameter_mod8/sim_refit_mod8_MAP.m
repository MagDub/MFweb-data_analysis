function sim_refit_mod8_MAP(ID)

    sim_dir = ('../../../../data/sim_recov/mod_8/n_sim_100/');
    ...
    % settings
    settings = [];
    settings.desc                   = ['mod8_' int2str(ID)];   
    ...
    %% prior
    load('/home/mdubois/data/priors/thompson_q0_norm/empirical_prior.mat'); %from generate_empirical_priors.mend
