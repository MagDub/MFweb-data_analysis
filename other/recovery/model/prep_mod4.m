function inp_params = prep_mod4(param_bounds, saving_dir, n_sim, param_mean, param_std)
    ...
    v_eta_1     = sample_from_dist(param_mean(6), param_std(6), n_sim, param_bounds.eta);
    v_eta_2     = sample_from_dist(param_mean(7), param_std(7), n_sim, param_bounds.eta);
    v_w_hyb     = sample_from_dist(param_mean(7), param_std(7), n_sim, param_bounds.w_hyb);
