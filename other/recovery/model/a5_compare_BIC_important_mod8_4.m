...
model_mat = [9,5,10,6,11,7,12,8, 4];
...
for mod_n=1:n_models
    ...
    elseif mod == 4
       file_BIC = strcat(sim_fol,'mod',num2str(sim_model),'_normal_gamma_0_0.5_tau_20_70_sgm0_1_300/n_sim_',num2str(n_sim),'/results/all_BIC_mat.mat');
    else
...
legend_all{9}  = 'hybrid + \epsilon + \eta';
...
yticks([1:n_mod])
yticklabels({legend_all{1}, legend_all{2}, legend_all{3}, legend_all{4}, legend_all{5}, legend_all{6}, legend_all{7}, legend_all{8}, legend_all{9}})
ylim([0.5 n_mod+0.5])

xticks([1:n_mod])
xticklabels({legend_all{1}, legend_all{2}, legend_all{3}, legend_all{4}, legend_all{5}, legend_all{6}, legend_all{7}, legend_all{8}, legend_all{9}})
xtickangle(45)
xlim([0.5 n_mod+0.5])
