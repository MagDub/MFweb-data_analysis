function [nMAP, nLogL, mo, logL] = modelMF_S0fixed_eta_thomp4param_MAP_2sgm0(param_val,param_names,sID,settings,data,gameIDs, prior, param_names_prior)
holly = 0;
