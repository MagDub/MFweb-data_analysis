...
function [settings, data, gameIDs] = sim_mod6_Q0fixed(ID, para_vals, param_bounds, sim_dir)
    ...
    settings.desc                   = ['mod6'];    
    settings.params.param_names     = {'gamma'  ''  'tau'  ''  'xi'  ''};   
    settings.params.lb              = [param_bounds.gamma(1) param_bounds.gamma(1) param_bounds.tau(1) param_bounds.tau(1) param_bounds.xi(1) param_bounds.xi(1)];    % lower bound
    settings.params.ub              = [param_bounds.gamma(2) param_bounds.gamma(2) param_bounds.tau(2) param_bounds.tau(2) param_bounds.xi(2) param_bounds.xi(2)];    % upper bound
