...
function [settings, data, gameIDs] = sim_mod7(ID, para_vals, param_bounds, sim_dir)
    ...
    settings.params.lb              = [param_bounds.Q0(1) param_bounds.gamma(1) param_bounds.gamma(1) param_bounds.tau(1) param_bounds.tau(1) param_bounds.eta(1) param_bounds.eta(1)];    % lower bound
    settings.params.ub              = [param_bounds.Q0(2) param_bounds.gamma(2) param_bounds.gamma(2) param_bounds.tau(2) param_bounds.tau(2) param_bounds.eta(2) param_bounds.eta(2)];    % upper bound
