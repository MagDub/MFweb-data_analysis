function inp_params = prep_mod7_normal(param_bounds, saving_dir, n_sim, param_mean, param_std)
    ...
    inp_params = [v_Q0, v_gamma_1, v_gamma_2, v_tau_1, v_tau_2, v_eta_1, v_eta_2];
