function inp_params = prep_mod6_normal_Q0fixed(param_bounds, saving_dir, n_sim, param_mean, param_std)
    ...
    inp_params = [v_gamma_1, v_gamma_2, v_tau_1, v_tau_2, v_xi_1, v_xi_2];
