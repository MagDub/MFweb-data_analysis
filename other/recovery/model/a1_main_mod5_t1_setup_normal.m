...
n_sim = 100;
path_ = '/Users/magdadubois/MFweb/data/sim_model_recov/mod5_t1_normal/';
saving_dir = strcat(path_, 'n_sim_', int2str(n_sim), '/');

load('../../../../data/modelfit/mod5_t1/concatenated/model_parameters_mod5_t1.mat')
load('../../../../data/modelfit/mod5_t1/concatenated/model_parameters_mod5_t1_desc.mat')
...
inp_params = prep_mod5_t1_normal_Q0fixed(param_bounds, saving_dir, n_sim, param_mean, param_std);
