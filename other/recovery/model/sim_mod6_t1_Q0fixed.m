...
function [settings, data, gameIDs] = sim_mod6_t1_Q0fixed(ID, para_vals, param_bounds, sim_dir)
    ...
    % initialise model
    mo = initialise_model_MF_S0fixed_sgm0fixed_taufixed_Q0fixed(settings);
