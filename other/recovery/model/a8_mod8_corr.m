...
subplot(3,4,1)
title_ = '\fontsize{22} Q0';
legend_position = [0.123456790123457 0.825427395957974 0.0846560846560847 0.0535986493795997];
render_corr(para_vals_fitted(:,1),para_vals_generated(:,1), param_bounds.Q0, [1:1:10], title_, 'a', legend_position);
...
render_corr(para_vals_fitted(:,2),para_vals_generated(:,2), [min_, max_], [0:1:4], title_, 'b', legend_position);
...
render_corr(para_vals_fitted(:,3),para_vals_generated(:,3), [min_, max_], [0:1:4], title_, 'c', legend_position);
...
render_corr(para_vals_fitted(:,4),para_vals_generated(:,4), [min_, max_], [0:1:4], title_, 'd', legend_position);
...
render_corr(para_vals_fitted(:,5),para_vals_generated(:,5), [min_, max_], [0:1:4], title_, 'e', legend_position);
...
render_corr(para_vals_fitted(:,6),para_vals_generated(:,6), [min_, max_], [0:1:4], title_, 'f', legend_position);
...
render_corr(para_vals_fitted(:,7),para_vals_generated(:,7), [min_, max_], [0:1:4], title_, 'g', legend_position);
...
render_corr(para_vals_fitted(:,8),para_vals_generated(:,8), [min_, max_], [0:1:6], title_, 'g', legend_position);

subplot(3,4,9)
title_ = '\fontsize{22} \eta_{LH}';
legend_position = [0.191358024691358 0.0985285392935018 0.0846560846560845 0.0846138346628574];
min_ = min(min(para_vals_fitted(:,9), para_vals_generated(:,9)));
max_ = max(max(para_vals_fitted(:,9), para_vals_generated(:,9)));
render_corr(para_vals_fitted(:,9),para_vals_generated(:,9), [min_, max_], [0:1:6], title_, 'h', legend_position);
