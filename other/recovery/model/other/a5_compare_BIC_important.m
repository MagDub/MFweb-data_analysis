...
legend_all{1} = 'hybrid + \epsilon + \eta';
legend_all{2}  = 'UCB + \epsilon + \eta';
legend_all{3}  = 'thompson';
legend_all{4}  = 'thompson + \epsilon';
legend_all{5}  = 'thompson + \eta';
legend_all{6}  = 'thompson + \epsilon + \eta';
...
yticks([1:n_mod])
yticklabels({legend_all{1}, legend_all{2}, legend_all{3}, legend_all{4}, legend_all{5}, legend_all{6}})
ylim([0.5 n_mod+0.5])
