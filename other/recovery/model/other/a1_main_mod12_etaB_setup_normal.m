...
n_sim = 100;
path_ = '/Users/magdadubois/MFweb/data/sim_model_recov/mod12_etaB_normal/';
saving_dir = strcat(path_, 'n_sim_', int2str(n_sim), '/');

load('../../../../data/data_for_figs/model_parameters_mod12etaB.mat')
load('../../../../data/data_for_figs/model_parameters_mod12etaB_desc.mat')
...
param_bounds.etaB = param_bounds_eta; 

param_bounds.gamma = param_bounds_gamma; 
param_bounds.tau = param_bounds_tau; 

inp_params = prep_mod12_etaB_normal(param_bounds, saving_dir, n_sim, param_mean, param_std);
