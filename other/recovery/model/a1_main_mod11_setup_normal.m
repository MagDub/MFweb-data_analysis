...
n_sim = 100;
path_ = '/Users/magdadubois/MFweb/data/sim_model_recov/mod11_normal/';
saving_dir = strcat(path_, 'n_sim_', int2str(n_sim), '/');

load('../../../../data/modelfit/mod11/concatenated/model_parameters_mod11.mat')
load('../../../../data/modelfit/mod11/concatenated/model_parameters_mod11_desc.mat')
...
inp_params = prep_mod11_normal(param_bounds, saving_dir, n_sim, param_mean, param_std);
