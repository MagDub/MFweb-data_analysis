...
function [] = render_param_recovery_mod8_Q0fixed(out)
    
    %% Parameter and parameter names

    n_param = 8;

    param_legends{1} = '\gamma_{SH}';
    param_legends{2} = '\gamma_{LH}';
    param_legends{3} = '\tau_{SH}';
    param_legends{4} = '\tau_{LH}';
    param_legends{5} = '\epsilon_{SH}';
    param_legends{6} = '\epsilon_{LH}';
    param_legends{7} = '\eta_{SH}';
    param_legends{8} = '\eta_{LH}';
    ...
    xlim([0.5 8.5])
    xticklabels({param_legends{1}, param_legends{2}, param_legends{3}, param_legends{4}, param_legends{5}, param_legends{6}, param_legends{7}, param_legends{8}})
    yticks([1 2 3 4 5 6 7 8])
    ylim([0.5 8.5])
    yticklabels({param_legends{1}, param_legends{2}, param_legends{3}, param_legends{4}, param_legends{5}, param_legends{6}, param_legends{7}, param_legends{8}})
