...
function [] = render_param_recovery_mod8(out)
    ...
    param_legends{1} = 'Q_0';
    param_legends{2} = '\gamma_{SH}';
    param_legends{3} = '\gamma_{LH}';
    param_legends{4} = '\tau_{SH}';
    param_legends{5} = '\tau_{LH}';
    param_legends{6} = '\epsilon_{SH}';
    param_legends{7} = '\epsilon_{LH}';
    param_legends{8} = '\eta_{SH}';
    param_legends{9} = '\eta_{LH}';
    ...
    ylim([0.5 9.5])
    yticklabels({param_legends{1}, param_legends{2}, param_legends{3}, param_legends{4}, param_legends{5}, param_legends{6}, param_legends{7}, param_legends{8}, param_legends{9}})
