function fit_mod4_Q0fixed(ID, data_fol, sim_dir, settings, data, gameIDs, param_bounds)
    ...
    settings.params.lb              = [param_bounds.Q0(1) param_bounds.sgm0(1) param_bounds.sgm0(1) param_bounds.gamma(1) param_bounds.gamma(1) param_bounds.tau(1) param_bounds.tau(1) param_bounds.xi(1) param_bounds.xi(1) param_bounds.eta(1) param_bounds.eta(1) param_bounds.w_hyb(1)];    % lower bound
    settings.params.ub              = [param_bounds.Q0(2) param_bounds.sgm0(2) param_bounds.sgm0(2) param_bounds.gamma(2) param_bounds.gamma(2) param_bounds.tau(2) param_bounds.tau(2) param_bounds.xi(2) param_bounds.xi(2) param_bounds.eta(2) param_bounds.eta(2) param_bounds.w_hyb(2)];    % upper bound
