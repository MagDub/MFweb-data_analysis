...
function [settings, data, gameIDs] = sim_mod5(ID, para_vals, param_bounds, sim_dir)
    ...
    settings.desc                   = ['mod5'];    
    settings.params.param_names     = {'Q0' 'gamma'  ''  'tau'  ''};   
    settings.params.lb              = [param_bounds.Q0(1) param_bounds.gamma(1) param_bounds.gamma(1) param_bounds.tau(1) param_bounds.tau(1)];    % lower bound
    settings.params.ub              = [param_bounds.Q0(2) param_bounds.gamma(2) param_bounds.gamma(2) param_bounds.tau(2) param_bounds.tau(2)];    % upper bound
