function [] = render_fig_choices(cond, horizon, choice_No, title_, ylabel_, letter_)

    % load
    load('./concat_data/desc_split.mat')
    T=load(strcat('./concat_data/split_mat_',horizon,'_',choice_No,'_',cond,'.mat'));

    tmp_data = T.(strcat('split_mat_',horizon,'_',choice_No,'_', cond));
