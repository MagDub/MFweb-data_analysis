%function [trees_, means_, mins_, maxs_, means_split_, mins_split_, maxs_split_, desc_split, choices_split_val, choices_split_min, choices_split_max] = concat_tree_size_init_SH(tmp_all)
