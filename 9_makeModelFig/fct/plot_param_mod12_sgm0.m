...
function [] = plot_param_mod12_sgm0(to_del)
    ...
    sgm0_SH = param_SH;
    sgm0_LH = param_LH;
    save('../../data/data_for_figs/mod12_sgm0_SH.mat', 'sgm0_SH')
    save('../../data/data_for_figs/mod12_sgm0_LH.mat', 'sgm0_LH')
    ...
    % Export
    addpath('../../export_fig')
    export_fig(['./fig/Fig_param_sgm0.tif'],'-nocrop','-r200')
