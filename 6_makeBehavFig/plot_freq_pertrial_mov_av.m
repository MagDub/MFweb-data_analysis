...
[mean_SH_A, sem_SH_A, beta_SH_A] = compute_val_mov_av(per_trial_freq_SH_A(:,2:end), n_part);
[mean_LH_A, sem_LH_A, beta_LH_A] = compute_val_mov_av(per_trial_freq_LH_A(:,2:end), n_part);

[mean_SH_B, sem_SH_B, beta_SH_B] = compute_val_mov_av(per_trial_freq_SH_B(:,2:end), n_part);
[mean_LH_B, sem_LH_B, beta_LH_B] = compute_val_mov_av(per_trial_freq_LH_B(:,2:end), n_part);

[mean_SH_C, sem_SH_C, beta_SH_C] = compute_val_mov_av(per_trial_freq_SH_C(:,2:end), n_part);
[mean_LH_C, sem_LH_C, beta_LH_C] = compute_val_mov_av(per_trial_freq_LH_C(:,2:end), n_part);

[mean_SH_D, sem_SH_D, beta_SH_D] = compute_val_mov_av(per_trial_freq_SH_D(:,2:end), n_part);
[mean_LH_D, sem_LH_D, beta_LH_D] = compute_val_mov_av(per_trial_freq_LH_D(:,2:end), n_part);

[mean_SH_M, sem_SH_M, beta_SH_M] = compute_val_mov_av(per_trial_exploreexploit_SH_M(:,2:end), n_part);
[mean_LH_M, sem_LH_M, beta_LH_M] = compute_val_mov_av(per_trial_exploreexploit_LH_M(:,2:end), n_part);

[mean_SH_H, sem_SH_H, beta_SH_H] = compute_val_mov_av(per_trial_exploreexploit_SH_H(:,2:end), n_part);
[mean_LH_H, sem_LH_H, beta_LH_H] = compute_val_mov_av(per_trial_exploreexploit_LH_H(:,2:end), n_part);

[mean_SH_BD, sem_SH_BD, beta_SH_BD] = compute_val_mov_av(per_trial_freq_SH_B(:,2:end)+per_trial_freq_SH_D(:,2:end), n_part);
[mean_LH_BD, sem_LH_BD, beta_LH_BD] = compute_val_mov_av(per_trial_freq_LH_B(:,2:end)+per_trial_freq_LH_D(:,2:end), n_part);
...
% Export
addpath('../../export_fig')
export_fig(['./fig/Fig_per_trial_freq_mov_av.tif'],'-nocrop','-r200')
