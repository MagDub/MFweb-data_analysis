function [nMAP, nLogL, mo, logL] = modelMF_S0fixed_thomp3param_MAP_2sgm0(param_val,param_names,sID,settings,data,gameIDs, prior)
...
param_names = {'sgm0', 'sgm0', 'Q0'}; %ignoring the two etas
