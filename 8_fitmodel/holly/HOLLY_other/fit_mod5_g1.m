function fit_mod5_g1(ID, data_fol)
    ...
    settings.params.lb              = [param_bounds_Q0(1) param_bounds_tau(1) param_bounds_tau(1)];    % lower bound
    settings.params.ub              = [param_bounds_Q0(2) param_bounds_tau(2) param_bounds_tau(2)];    % upper bound
