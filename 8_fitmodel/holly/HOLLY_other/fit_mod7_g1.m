function fit_mod7_g1(ID, data_fol)
    ...
    settings.params.param_names     = {'Q0' 'tau'  ''  'eta' ''};   
    settings.params.lb              = [param_bounds_Q0(1) param_bounds_tau(1) param_bounds_tau(1) param_bounds_eta(1) param_bounds_eta(1)];    % lower bound
    settings.params.ub              = [param_bounds_Q0(2) param_bounds_tau(2) param_bounds_tau(2) param_bounds_eta(2) param_bounds_eta(2)];    % upper bound
    ...
    param_names = {'Q0','tau', 'tau', 'eta', 'eta'};
