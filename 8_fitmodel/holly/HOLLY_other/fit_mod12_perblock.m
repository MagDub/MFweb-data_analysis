function fit_mod12_perblock(ID, data_fol, block_)

    algo = strcat('mod12_block_', num2str(block_));
    ...
    [data,gameIDs] = aggregateData_singleblock(ID,data_dir, block_);
