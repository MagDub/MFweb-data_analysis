function mo = lapseB(mo,idx_hor,idx_g,t,blocks)
...
if length(mo.params.xiB) > 1
    xiB = mo.params.xiB(idx_hor);
else
    xiB = mo.params.xiB;
end
...
%% add lapse
%pi = pi .* (1 - xi) + xi / 3;
doublexi = xi+(xiB*(blocks-2.5)); % trial: 1:400 -> -199.5:199.5 (centralised)
