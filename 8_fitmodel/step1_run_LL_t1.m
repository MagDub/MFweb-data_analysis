...
mle_mat_all_desc = {'mle_thompson', 'mle_thompson_eps', 'mle_thompson_eta', 'mle_thompson_eps_eta',...
        ...
        'mle_UCB_t1', 'mle_UCB_t1_eps', 'mle_UCB_t1_eta', 'mle_UCB_t1_eps_eta'};
...
BIC_all_desc = {'BIC_thompson', 'BIC_thompson_eps', 'BIC_thompson_eta', 'BIC_thompson_eps_eta',...
        ...
        'BIC_UCB_t1', 'BIC_UCB_t1_eps', 'BIC_UCB_t1_eta', 'BIC_UCB_t1_eps_eta'};
    
BIC_all = 2*mle_mat_all + log(400).*[3, 5, 5, 7,    5, 7, 7, 9,     8, 10, 10, 12,      3, 5, 5, 7];

save('mle_mat_all_t1.mat', 'mle_mat_all');
save('mle_mat_all_t1_desc.mat', 'mle_mat_all_desc');
save('../../data/data_for_figs/mle_mat_all_t1.mat', 'mle_mat_all');
save('../../data/data_for_figs/mle_mat_all_t1_desc.mat', 'mle_mat_all_desc');
